  ...
  return (
    <div className="container">
      ...
      <Routes>
        ...
        <Route path="/" element={<div className="card p-4"><h2 className="display-4">Welcome to OctoFit Tracker!</h2><p className="lead">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
      </Routes>
    </div>
  );
}
